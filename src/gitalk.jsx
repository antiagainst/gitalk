...
class GitalkComponent extends Component {
  ...
  header () {
    const { user, issue, comment, isCreating } = this.state
    return (
      <div className="gt-header" key="header">
        <Svg className="gt-ico-tip" name="tip"/> &nbsp;
        <span>
          Comments are hosted on GitHub using GitHub issues. Leave a comment by directly posting on &nbsp;
